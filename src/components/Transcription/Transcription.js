...
const Transcription = ({ setMeetingState, meetingState }) => {
console.log(meetingState.transcription)
// animation corect madu;
  return (
    <>
      <button id="drag-container">
        <FontAwesomeIcon
          className="text-3xl absolute text-black m-3"
          icon={faAngleRight}
          onClick={() =>
      ...
      <div className={`messenger-container from-left ${meetingState.transcription&&'from-right'} mx-2 my-3 rounded-md `}>
